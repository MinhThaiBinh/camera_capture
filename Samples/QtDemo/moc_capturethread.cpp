...
QT_MOC_LITERAL(4, 28, 14), // "unsigned char*"
QT_MOC_LITERAL(5, 43, 6) // "buffer"

    },
    "CaptureThread\0captured\0\0img\0unsigned char*\0"
    "buffer"
};
...
void CaptureThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->captured((*reinterpret_cast< QImage(*)>(_a[1])),(*reinterpret_cast< unsigned char*(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (CaptureThread::*)(QImage , unsigned char * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CaptureThread::captured)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CaptureThread::captured(QImage _t1, unsigned char * _t2)
{
